  ...
  return (
    <section id="heritage" className="snap-section bg-[#0a0700] relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row w-full lg:h-full">
        {/* CAFÉ */}
        <div className="w-full lg:w-1/2 relative group flex flex-col justify-end min-h-[55vh] lg:h-full overflow-y-auto lg:overflow-hidden">
        ...
        {/* CACAO */}
        <div className="w-full lg:w-1/2 relative group flex flex-col justify-end min-h-[55vh] lg:h-full border-t lg:border-t-0 border-white/10 lg:border-l overflow-y-auto lg:overflow-hidden">
          <div className="absolute inset-0 bg-black z-0">
